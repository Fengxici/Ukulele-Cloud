...
import static timing.ukulele.gateway.filter.GatewayHeaderConstants.HEADER_LABEL;
...
public class XlabelRequestPreFilter extends ZuulFilter {
    ...
    public Object run() {
        ...
        XlabelMvcHeaderInterceptor.initHystrixRequestContext(requestContext.getZuulRequestHeaders().get(HEADER_LABEL));
        return null;
    }
}
