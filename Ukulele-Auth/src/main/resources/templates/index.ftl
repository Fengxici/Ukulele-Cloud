...
<div class="ui modal" id="modal">
    <div class="header title">授权中心-应用列表
...
<script src="${request.contextPath}/webjars/jquery/3.3.1-2/jquery.min.js" ></script>
<script src="${request.contextPath}/webjars/Semantic-UI/2.4.1/semantic.min.js" ></script>
<script>
