...
<head>
    ...
    <link rel="stylesheet" href="${request.contextPath}/webjars/Semantic-UI/2.4.1/semantic.min.css"/>
</head>
<style type="text/css">
    body {
        ...
        <form id="form" class="ui large form" action="login" method="post" style="border: 0">
            <div class="ui stacked segment">
                ...
                <div class="field item" style="height: 80px">
                    ...
                    <div class="other">忘记密码？试试 &nbsp;<a href="javascript:void(0);" onclick="change_yzm()"><i
                                    class="mobile icon"></i>验证码登陆</a>|<a><i class="qrcode icon"></i>扫码登陆</a></div>
                </div>
        ...
        <form id="form1" class="ui large form transition hidden" action="login" method="post" style="border: 0;">
            <div class="ui stacked segment">
                ...
                <div class="field item" style="height: 80px">
                    ...
                    <div class="other">返回 &nbsp;<a href="javascript:void(0);" onclick="change_default()"><i
                                    class="user icon"></i>账号密码</a>| <a><i class="qrcode icon"></i>扫码登陆</a></div>
                </div>
