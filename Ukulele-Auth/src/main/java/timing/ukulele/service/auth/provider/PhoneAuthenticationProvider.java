...
// * 手机验证码登陆
// */
//public class PhoneAuthenticationProvider extends TimingAbstractUserDetailsAuthenticationProvider {
//
...
//        PhoneAuthenticationToken result = new PhoneAuthenticationToken(principal, authentication.getCredentials(),"phone", user.getAuthorities());
